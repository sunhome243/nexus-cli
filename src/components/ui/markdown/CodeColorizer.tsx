/**
 * Code syntax highlighting component for terminal output
 * Uses lowlight (highlight.js) to colorize code blocks
 */
...
import { themeManager } from './theme-adapter.js';
import { Theme } from './theme-adapter.js';
import {
  MaxSizedBox,
  MINIMUM_MAX_HEIGHT,
} from './MaxSizedBox.js';
 ...
 * @param availableHeight Optional maximum height for the code block
 * @param maxWidth Optional maximum width for the code block
...
export function colorizeCode(
  ...
  try {
    ...
    // Error highlighting code - fallback to plain text with default color

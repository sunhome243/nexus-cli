/**
 * Inline markdown renderer for text formatting
 * Handles bold, italic, strikethrough, code, links, and underline
 */
...
const RenderInlineInternal: React.FC<RenderInlineProps> = ({ text }) => {
  ...
  while ((match = inlineRegex.exec(text)) !== null) {
    ...
    try {
      ...
      // Error parsing inline markdown part - fallback to plain text
      renderedNode = null;
    }
